...
GameplayMultiPlayerHost::GameplayMultiPlayerHost()
{
...
void GameplayMultiPlayerHost::Load(Socket& sock)
{
...
void GameplayMultiPlayerHost::Unload()
{
	power.Unload();
...
Transition GameplayMultiPlayerHost::Update(float deltaTime, Socket& sock, NetworkData& networkData)
{
	...
	multiPlayerManagerHost.Update(deltaTime, sock, networkData);
...
void GameplayMultiPlayerHost::Render()
{
	background.Render();
	...
	multiPlayerManagerHost.Render();

	EnemyManager::Get()->Render();
}

void GameplayMultiPlayerHost::CheckCollision()
{
